function [newPopulation, newPopFitness] = selectionOperationOfTournament(population, popFitness)
% 锦标赛选择,适应度越大被选择的概率越高
