...
% The default output function of ALGORITHM
    ...
    if Problem.FE >= Problem.maxFE
        ...
        elseif Algorithm.save > 0
            CalMetric(Algorithm, 'IGD');
            Algorithm.metric.IGD(:, 1) = [];
            
            CalMetric(Algorithm, 'HV');
            Algorithm.metric.HV(:, 1) = [];
            
            CalMetric(Algorithm, 'GD');
            Algorithm.metric.GD(:, 1) = [];
        
        
%             Algorithm.metric.IGD = Algorithm.metric.IGD(:, 2);
